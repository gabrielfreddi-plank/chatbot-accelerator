...
export async function POST(request: Request) {
  ...
  // Detached IIFE inside a sync `start` so Next.js flushes response headers
  // and each enqueued chunk to the client immediately, instead of buffering
  // until the start promise resolves.
